...
<head>
    ...
    <!-- Styles -->
    <link href="{!! asset('css/libs/bootstrap.min.css',true) !!}" media="all" rel="stylesheet" type="text/css" />
    <link href="{!! asset('css/stil.css', true) !!}" media="all" rel="stylesheet" type="text/css" />
